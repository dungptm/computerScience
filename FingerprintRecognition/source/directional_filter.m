%--------------------------------------------------------------------------
% y = directional_filter(blk,th,f)
%
% Loc theo huong ket hop voi viec xoan trong mien tan so (FFT)
% 
% blk       - kích thuoc block
% th        - huong cuc bo cua block
% f         - tan so cuc bo cua block
%--------------------------------------------------------------------------
